...
def calc_game_results(player_result, opp_result, draw_result):
...
def calc_overall_game_stats(player_result, opp_result, draw_result):
    if player_result > opp_result and player_result > draw_result:
        print('YOU WIN THE GAME 🏆')
    elif opp_result > player_result and opp_result > draw_result:
        print('YOU LOST THE GAME. Better Luck next time')
    elif player_result == opp_result:
        print('Draw')
    elif draw_result > player_result or draw_result > opp_result:
        print('No-one wins')
...
for game in range(4):
    ...
    calc_game_results(player_result, opp_result, draw_result)

    with open("resultsFile.txt", "w") as f:
        for result in enumerate(game_results):
            f.write(str(result) + "\n")

calc_overall_game_stats(player_result, opp_result, draw_result)
